    ...
    module ORM
      class Requester
        class << self
          ...
          def load(resource: "", filter: Api::Data::MarketFilter.new, params: {})
        ...
        private
          ...
          def current_provider
            @_current_provider ||= BetfairApiNgRails::Api::Provider.new
          end

          def build_parser(method, responser)
            "BetfairApiNgRails::Api::ORM::Parsers::#{method.to_s.camelize}".constantize.new responser
          end
